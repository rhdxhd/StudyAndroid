...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //View를 상속받은 모든 위젯들은 (화면에 보이는 모든것들 레이아웃 포함 ) 사용자의 클릭을 감지하는 view.OnClickListener를 가지고 있다.
        ...
        btn_change.setOnClickListener(v -> {
            ...
            //버튼을 누르면 3번이미지 사라짐, 2번 이미지 사라짐, 1번이미지 사라짐이 각각 되게 처리해보기.
            //1, 2, 3 -> 1, 2, 3, -> 1, 2, ...
            ...
            //imgv2.setVisibility(View.GONE);
            //imgv3.setVisibility(View.GONE);
            //Log.d("ABC LOG", "내가 쓰고 싶은거 String");
            //Log.e("ABC LOG", "Error Log", null);
            //Log.i("ABC LOG", "Info 뭔가 정보를 표기할때");
            //여기서 이벤트 처리

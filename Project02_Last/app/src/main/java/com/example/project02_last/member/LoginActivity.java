...
public class LoginActivity extends AppCompatActivity {
    ...
    //네이티브 앱 : f673de42a808e9e38013ff372cba8127
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NaverIdLoginSDK.INSTANCE.initialize(this , getString(R.string.CLIENT_ID_NAVER) , getString(R.string.CLIENT_SECRET_NAVER) , "Project02_Last");
...
//        });
    ...
    public void kakaoLogin(Context context){
        ...
        KakaoSdk.INSTANCE.init(this, "f673de42a808e9e38013ff372cba8127");
